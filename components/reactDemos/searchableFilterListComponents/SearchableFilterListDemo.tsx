...
import ActionablesList from "../actionablesListComponents/ActionablesList";
import ActionablesLI from "../actionablesListComponents/ActionablesLI";
...
const SearchableFilterListDemo = () => {
...
export default SearchableFilterListDemo;